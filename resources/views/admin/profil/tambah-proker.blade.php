...
@section('content')
    <div class="container-fluid px-4">
        <h1 class="mt-4">Tambah Proker</h1>
        <div class="card mb-4">
            <div class="card-header">
                <i class="fas fa-add me-1"></i>
                Tambah Proker BU Malang
            </div>
            <div class="card-body">
                <form action="{{ route('admin.store-proker') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Simpan Data Proker
                    </button>
                </form>
            </div>
        </div>
